...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20231108115509_initial')
BEGIN
...
BEGIN
    ...
    VALUES (N'20231108115509_initial', N'6.0.24');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20231108124932_seedauthors')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20231108124932_seedauthors', N'6.0.24');
END;
GO
